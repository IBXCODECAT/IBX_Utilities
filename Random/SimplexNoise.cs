...
namespace IBX_Utilities.Random
{
    ...
    {
        /// <summary>
        /// Generates 1D Perlin Noise using Simplex
        /// </summary>
        /// <param name="width"></param>
        /// <param name="scale">Noise Scale</param>
        /// <returns>Float array containing noise values</returns>
        public static float[] Perlin(int width, float scale)
        {
        ...
        /// <summary>
        /// Generates 2D Perlin Noise using Simplex
        /// </summary>
        /// <param name="width"></param>
        /// <param name="height"></param>
        /// <param name="scale">Noise Scale</param>
        /// <returns>Two dimensional float array containing noise values</returns>
        public static float[,] Perlin(int width, int height, float scale)
        {
        ...
        /// <summary>
        /// Generates 3D Perlin Noise using Simplex
        /// </summary>
        /// <param name="width"></param>
        /// <param name="height"></param>
        /// <param name="length"></param>
        /// <param name="scale">Noise Scale</param>
        /// <returns>Three dimensional float array containing noise values</returns>
        public static float[,,] Perlin(int width, int height, int length, float scale)
        {
        ...
        public static float Pixel1D(int x, float scale)
        {
            return Generate(x * scale) * 128 + 128;
        }

        public static float Pixel2D(int x, int y, float scale)
        {
            return Generate(x * scale, y * scale) * 128 + 128;
        }

        public static float Pixel3D(int x, int y, int z, float scale)
        {
